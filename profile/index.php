        ...
        <header class="bg-white py-8 border-b">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between">
                    <h1 class="text-3xl font-bold leading-tight text-gray-900 mt-4">Name</h1>
                ...
                <div class="mt-4 flex gap-1">
                    ...
                    <p class="flex-1">Joined Month 202X</p>
                </div>
                <div class="mt-2 gap-4 flex">
                    <p class=""><span class="mr-1 font-semibold">123</span>Followers</p>
                    <p class=""><span class="mr-1 font-semibold">456</span>Following</p>
                </div>
            </div>
        </header>
